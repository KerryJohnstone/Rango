...
def populate():
    ...
    python_pages = [
        {"title": "Official Python Tutorial", "url":"http://docs.python.org/2/tutorial/", "views":26},
        {"title":"How to Think like a Computer Scientist", "url":"http://www.greenteapress.com/thinkpython/", "views":25},
        {"title":"Learn Python in 10 Minutes", "url":"http://korokithakis.net/tutorials/python/", "views":34}
    ]

    django_pages = [
        {"title":"Official Django Tutorial", "url":"https://www.tangowithdjango.com/", "views":18},
